		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comleservalvestar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comleservalvestar-display": {
								"semanticObject": "comleservalvestar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.leser.valvestar",
									"url": sap.ui.require.toUrl("com/leser/valvestar")
								}
							}
						}
					}
